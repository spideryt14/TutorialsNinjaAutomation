...
public class TC_RF_005 {
    ...
    @Test
    public void registerTestWithNewsletterYes() {
        ...
        // Step 4 - Select 'Yes' for Newsletter
        ...
        // ER-3 - Assert 'Yes' is selected
        Assert.assertTrue(driver.findElement(By.xpath("//ul[@class='breadcrumb']//a[normalize-space()='Newsletter']")).isDisplayed());
        Assert.assertTrue(driver.findElement(By.xpath("//input[@value='1']")).isSelected(), "'Yes' option is not selected!");
